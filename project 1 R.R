# you need to do two projects that show you have the ability to 
...
# Use data_1 and data_2 for the 4 steps above in two separate R script files
# when put on github, try and make it interactive by the box codes to show graphs etc 
...
#conclusion:
# Most of the respondents were white, between 25-34 and earned well above the median UK salary
